...
graph TB
    subgraph docker["Docker Compose"]
        ...
        loadgen["Load Generator<br/>(k6 / Python)"]
...
```mermaid
graph TB
    subgraph overview["5-1. Overview 패널"]
        r1l["Total Requests (Rate)<br/>[시계열 그래프]"] --- r1r["Error Rate (%)<br/>[시계열 그래프]"]
        r2l["Active Requests<br/>[Gauge]"] --- r2r["Queue Depth<br/>[Gauge]"]
    end
```
...
```mermaid
graph TB
    subgraph latency["5-2. Latency 패널"]
        r1l["Request Duration<br/>P50 / P95 / P99<br/>[시계열 그래프]"] --- r1r["TTFT Distribution<br/>P50 / P95 / P99<br/>[히스토그램]"]
        r2l["Tokens Per Second<br/>[시계열 그래프]"] --- r2r["Input vs Output Tokens<br/>[시계열 그래프]"]
    end
```
...
```mermaid
graph TB
    subgraph resource["5-3. Resource 패널"]
        r1l["Memory Usage<br/>[시계열 그래프]"] --- r1r["GPU Utilization (Metal)<br/>[시계열 그래프]"]
    end
```
